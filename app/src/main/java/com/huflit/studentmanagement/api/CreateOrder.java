package com.huflit.studentmanagement.api;


import static com.huflit.studentmanagement.utilities.Constants.APP_ID;

import com.huflit.studentmanagement.utilities.Constants;
import com.huflit.studentmanagement.utilities.Helpers;
...
public class CreateOrder {
    private class CreateOrderData {
        ...
        private CreateOrderData(String amount) throws Exception {
            ...
            Mac = Helpers.getMac(Constants.MAC_KEY, inputHMac);
        }
    }
    ...
    public JSONObject createOrder(String amount) throws Exception {
        ...
        JSONObject data = HttpProvider.sendPost(Constants.URL_CREATE_ORDER, formBody);
        return data;
    }
}
